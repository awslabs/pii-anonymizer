...
For guidance on securely deploying and operating this project (encryption, IAM, VPC, hardening items, and a pre-deployment checklist), see the [Security Guide](docs/SECURITY.md).
